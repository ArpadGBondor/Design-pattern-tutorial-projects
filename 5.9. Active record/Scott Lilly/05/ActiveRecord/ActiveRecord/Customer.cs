...
namespace ActiveRecord
{
    class Customer
    {
        ...
        // This method acts like an object factory for Customer objects,
        ...
        // This method is not static! It uses the Customer object's properties.
        public void Save()
        {
            // This method needs to handle INSERT (new Customer) and UPDATE (existing Customer).
            // Or, you need to create two separate functions, and call them when appropriate.

            // This function would not need to recieve a parameter, with customer object.
            // It's inside the Customer object, so all property values are already available to it.
        ...
        public void Delete()
        {
            using (SqlConnection connection = new SqlConnection(CONNECTION_STRING))
            {
                ...
                using (SqlCommand command = connection.CreateCommand())
                {
                    ...
                    // This function didn't need to recieve that value from a parameter.
